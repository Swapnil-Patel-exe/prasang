<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberProfile.aspx.cs" Inherits="Aboutus" %>
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <p class="w3-large w3-text-theme"><b><i class="fa fa-globe fa-fw w3-margin-right w3-text-teal"></i>Recent Event Done</b></p>
          <p> <asp:Label ID="lblEvent" runat="server" ></asp:Label></p>
