<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminUserRemove.aspx.cs" Inherits="UserHome" %>
    ...
    <table style=" width: 100%; height:auto">
        <tr>
            <td>
                ...
                <span class="auto-style1">&nbsp;Remove  BlackListed User   Form</span></td>
        </tr>
              <tr>
            <td>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:db %>" SelectCommand="SELECT [RId], [ClientId], [Name], [Email], [Address], [City], [MobileNo] FROM [ClientInfo]"></asp:SqlDataSource>
                  </td>
        </tr>
        </table>
