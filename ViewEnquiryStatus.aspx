<%@ Page Title="" Language="C#" MasterPageFile="~/user.master" AutoEventWireup="true" CodeFile="ViewEnquiryStatus.aspx.cs" Inherits="confirmenquiry" %>
                  ...
                  <td >
                      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Vertical">
                          ...
                          <Columns>
                              ...
                              <asp:BoundField DataField="OfferPrice" HeaderText="OfferPriceByYou" SortExpression="OfferPrice" />
                      ...
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:db %>" SelectCommand="SELECT DISTINCT [EnquiryId], [EventId], [EnquiryDate], [EnquiryDescription],[OfferPrice] , [Status] FROM [EnquiryInfo] WHERE ([RequestUserID] = @RequestUserID)">
                          <SelectParameters>
                              <asp:SessionParameter Name="RequestUserID" SessionField="GId" Type="String" />
                          </SelectParameters>
                      </asp:SqlDataSource>
                  </td>
              </tr>
