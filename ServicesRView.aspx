<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ServicesRView.aspx.cs" Inherits="Aboutus" %>
...
<ItemTemplate>
     ...
     <div style="font-size:10pt;background-color:#F9EF78; border-style:solid;border-width:1px; color:Black; Height:20px; Width:250px;  margin-bottom:10px; margin-left:15px">
       ...
       <div style="background-color:azure; margin-top:10px ;width: 250px; margin-left:15px">
         ...
         <div style=" margin-top:10px;text-align:left">
            <b>  About Event  : </b></div>
		       <div style=" margin-top:10px;text-align:left">
            <b>  <%# Eval("AboutEvent") %></b></div>
        <div style=" margin-top:10px;text-align:left">
          <b>Minmum Price ₹ :  <%# Eval("Price") %>
			  </b>
			  </div>
           <br />
        <div class="cell1">
        <asp:Label ID="lblVl"  runat="server" Text='<%#Eval("MemberId")%>' Visible="false"></asp:Label>
   <asp:LinkButton ID="LinkButton1"  BackColor="#0066CC" 
        ...
        <div class="cell2">
           <asp:Label ID="lblVideo"  runat="server" Text='<%#Eval("VideoLink")%>' Visible="false"></asp:Label>
           <asp:Label ID="detail"  runat="server" Text='<%#Eval("EventId")%>' Visible="false"></asp:Label>
