...
<!-- about -->
	<div class="welcome">
		<div class="container">
			...
			<p class="w3_para">Prasang offers an end-to-end wedding planning solution for couples to ideate & realize their dream wedding conveniently & reliably. Prasang is the only wedding planning startup in India that offers assisted wedding planning through personal wedding manager for all your needs of booking the perfect service provider. Prasang is also an encyclopedia of latest trends, expert opinions and practical advice on wedding planning - from choosing wedding theme, best lehenga designs, mehndi designs, sangeet ideas, photo poses, etc..</p>
			<div class="w3ls_news_grids"> 
				<div class="col-md-6 w3_agile_about_grid_left">
					<h3>
						We are passionate. We drive change. We move fast. We love to win. We value our team. We are supportive. We are kind. We are optimistic. We are creative. We collaborate. We say cheers.


						We are Prasang.
					</h3>
					<p><i> all starts with discovering the right idea so that you can make your wedding unique and fun! We host a tremendous collection of latest ideas, trends and practical advice - directly sourced from real wedding experiences of brides and vendors. Our fanatical wedding content team is an expert in bringing to you the most helpful and trendy ideas, which is why we’re followed and read by millions of brides!.</i> .</p>
				</div>
...
<!-- team -->
	<div class="welcome">
		<div class="container">
			...
			<p class="w3_para">Focus on creative work - We get done all the unproductive stuff for you, so that you can focus on improving customer’s experience through your creative excellence!.</p>
...
<!-- footer -->
	<div class="footer">
		<div class="container">
			...
			<p>© 2022 Prashang Events Planning. All rights reserved | Design by <a href="http://w3layouts.com/">PU</a></p>
		</div>
	</div>
<!-- //footer -->
