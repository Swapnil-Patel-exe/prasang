<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reg.aspx.cs" Inherits="Contactus" %>
...
<div class="col-xs-12 col-md-12">
        ...
        <div class="row form-group">
           ...
           <input class="form-control" name="city" type="text" id="txtSource"  placeholder=" Your  City" /
    ...
    <div class="row form-group">
            ...
            <div class="col-xs-12 col-md-6">
                ...
                <span class="field-validation-valid" data-valmsg-for="Panno" data-valmsg-replace="true"></span>
                               ...
                               <div class="row form-group">
            <div class="col-xs-12 col-md-6">
                <asp:TextBox runat="server" class="form-control"  id="txtExp"  placeholder=" About Your Self " type="text" value="" TextMode="MultiLine" />
                <span class="field-validation-valid" data-valmsg-for="Mobile" data-valmsg-replace="true"></span>
            </div>
            ...
            <p>By clicking "Register", you Accept that you are agree to our Privacy Policy and Terms of Service.</p>
                <asp:Button ID="Button1"  class="btn-primary btn" runat="server" 
                    Text="Save And Register " onclick="Button1_Click" Width="292px" />
