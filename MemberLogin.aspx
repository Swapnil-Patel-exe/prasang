<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberLogin.aspx.cs" Inherits="Contactus" %>
		...
		<div class="contact-main w3agile">
			<div class="col-md-7 contact-left">
			  <div class="contact-bottom">
				  <asp:TextBox ID="txtm" runat="server" placeholder="MobileNo" ></asp:TextBox>
			  		  <asp:TextBox ID="txtp" runat="server"   TextMode="Password" placeholder="Password" CssClass="pass" ></asp:TextBox>
			  	
			  		
				  <asp:Button ID="Button1" runat="server" Text="Login"  CssClass="btn" OnClick="Button1_Click"/>
				  	<br />
				  <hr />
				  <asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn" BackColor="#00CC99" NavigateUrl="~/MemberForgotPass.aspx">Forgot Password</asp:HyperLink>
				   <asp:HyperLink ID="HyperLink2" runat="server" CssClass="btn" BackColor="#0066FF" NavigateUrl="~/MemberRegistration.aspx">Sign Up</asp:HyperLink>
			  		<br />
				   <hr />
