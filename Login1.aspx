<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login1.aspx.cs" Inherits="Contactus" %>
...
<div class="contact">
	<div class="container">
	<b class="w3layouts_head">Login <span>To Access Services</span></b>
	
		<div class="contact-main w3agile">
			<div class="col-md-7 contact-left">
			  <div class="contact-bottom">
				  <asp:TextBox ID="txtmobile" runat="server" placeholder="MobileNo" ></asp:TextBox>
			  		  <asp:TextBox ID="txtPass" runat="server"   TextMode="Password" placeholder="Password" CssClass="pass" ></asp:TextBox>
			  	
			  		
				  <asp:Button ID="Button1" runat="server" Text="Login"  CssClass="btn" OnClick="Button1_Click"/>
				  	<br />
				  <hr />
				  <asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn" BackColor="#00CC99" NavigateUrl="~/UserForgotPass.aspx">Forgot Password</asp:HyperLink>
				   <asp:HyperLink ID="HyperLink2" runat="server" CssClass="btn" BackColor="#0066FF" NavigateUrl="~/Reg.aspx">Sign Up</asp:HyperLink>
			  		<br />
				   <hr />
			  <asp:Button ID="Button2" runat="server"  Text="Member Login Click Here"  CssClass="auto-style1" OnClick="Button2_Click" BackColor="#00CC00" Width="339px" CausesValidation="false"/>
			  </div>
			 </div>
