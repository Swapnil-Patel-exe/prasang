<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberResetPass.aspx.cs" Inherits="Contactus" %>
...
<div class="contact">
	<div class="container">
	<b class="w3layouts_head">Reset Password <span>To Access Services</span></b>
	
		<div class="contact-main w3agile">
			<div class="col-md-7 contact-left">
			  <div class="contact-bottom">
				  <asp:TextBox ID="txtmobile" runat="server" placeholder="Enter New Password" ></asp:TextBox>
